...
QUERY_URL_BOOST_NO_SCHEMA = 'http://localhost:8983/solr/book_no_schema/query?q=fast%20OR%20(capti*%20AND%20obs*)&q.op=OR&defType=edismax&indent=true&qf=pacing%5E5%20buzzwords&wt=json'
...
QUERY_URL_BOOST_SCHEMA = 'http://localhost:8983/solr/books_schema/query?q=fast%20OR%20(capti*%20AND%20obs*)&q.op=OR&defType=edismax&indent=true&qf=pacing%5E5%20buzzwords&wt=json'
