...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="77" style="display: block; width: 100%;">
    ...
    <header class="masthead" style="background-image:url('https://media.discordapp.net/attachments/1042104897866301470/1046865776814071808/background.png?width=1178&height=662');">
        <div class="intro-body" style="background: center / auto no-repeat;" id="picture-1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h1 class="brand-heading" style="width: 100%;">
                            <img src="../assets/logo.png" style="width: 100%;"></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto" style="font-family: Cabin, sans-serif;">
                    ...
                    <p style="font-family: Arial;">All you have to do is to want to find a new book, and it can be as specific or as vague as you prefer - but what are you doing reading this still? Go try it!</p>
                </div>
            </div>
        </div>
    </section>
    <section class="text-center download-section content-section" id="picture-2"></section>
    <section class="text-center content-section" id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <h2>Contact us</h2>
                    <p style="font-family: Arial;">We really want you to contact us, so use the following links that definitely work!<br>We wouldn't add buttons just because, yeah... totally!</p>
                    <ul class="list-inline banner-social-buttons">
                        <li class="list-inline-item">&nbsp;<button class="btn btn-primary btn-lg btn-default" type="button"><i class="far fa-envelope fa-fw"></i><span class="network-name">&nbsp; E-mail</span></button></li>
